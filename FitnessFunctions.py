...
TEAM_HUNT_BONUS_WEIGHT         = 1000.0
PREDATOR_COMM_BONUS_WEIGHT     = 30
PREDATOR_ENERGY_BONUS_WEIGHT   = 2
PREDATOR_SURVIVAL_BONUS_WEIGHT = 2
PREDATOR_STARVATION_PENALTY    = -300.0

# prey fitness function term weights
FOOD_EATEN_WEIGHT          = 200
GROUPING_BONUS_WEIGHT      = 80.0
PREY_SURVIVAL_BONUS_WEIGHT = 2.0
PREY_COMM_BONUS_WEIGHT     = 30.0
PREY_ENERGY_BONUS_WEIGHT   = 5.0
PREY_STARVATION_PENALTY    = -200.0
